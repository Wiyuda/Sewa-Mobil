...
<head>
    ...
    <title>Sewa Mobil | @yield('title')</title>

    <!-- Custom fonts for this template-->
    <link href="{{ url('backend/sbadmin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <script src="{{ url('backend/sbadmin/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ url('backend/sbadmin/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{ url('backend/sbadmin/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
